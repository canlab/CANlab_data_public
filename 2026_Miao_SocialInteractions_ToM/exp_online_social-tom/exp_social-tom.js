...
let expName = 'group3.1-3.2-social-tom';  // from the Builder filename that created this script
let expInfo = {
    'participantID': '',
};
...
async function experimentInit() {
  ...
  if (parID >= 5) {
      instructMes4 = "The continuous ratings are about how much you think **there are social interactions** at each moment in the story. Social interactions are communications or mutual actions between two or more people. Sentences that contain only one person, or that contain two or more people who are not interacting, are not about social interactions. For example, this sentence DOES contain social interactions: \n    \"Linda told Amy about her situation.\"\nThe following two sentences DO NOT contain social interactions: \n    \"Mark thought about his situation.\"\n    \"They are worried about their situation.\"\n\nPress \"space\" to continue, or press \"p\" to view the previous page.";
      continuousQ = "Are there social interactions?";
      label1 = "Not at all";
      label2 = "Partially";
      label3 = "Definitely yes";
      continuousQFull = "(How much do you think there are social interactions in the narrative at this moment?)";
      intQ = "On average, how much do you think there were social interactions during the last part of the narrative?";
      instructMes5 = "After each part of the story, you will answer another question about **on average**, how much you think there were social interactions in the last part of the story (see orange bar in the figure above). \n\nTo help you get familiar with the task, at the beginning, one sample part of narrative will be used for practice.  After that, all the following parts will be the formal survey.\n\nNow please press \"space\" to begin practicing.";
      psychoJS.experiment.addData('exp_question', 'social')
    } else {
      if (parID <= 4) {
          instructMes4 = "The continuous ratings are about how much you are **thinking about the mental states** of characters in the narrative at each moment. Mental states refer to the characters\u2019 thoughts, beliefs, and/or desires, but not about physical actions or sensations. \nFor example, if you ARE thinking about mental states of characters, you may be considering \u201cIs Bob angry?\u201d or \u201cLinda is planning on what to do.\u201d\nIf you are considering \u201cWhere is Dave heading?\u201d or \u201cAmy told Carl about her situation.\u201d, you ARE NOT thinking about mental states.\n\nPress \"space\" to continue, or press \"p\" to view the previous page.  ";
          continuousQ = "Thinking about mental states?";
          label1 = "Not at all";
          label2 = "Half the time";
          label3 = "All the time";
          continuousQFull = "(How much are you thinking about the mental states of characters in the narrative at this moment?)";
          intQ = "On average, how much were you thinking about the mental states of characters during the last part of the story?";
          instructMes5 = "After each part of the story, you will answer another question about **on average**, how much you were thinking about the mental states of characters (see orange bar in the figure above). \n\nTo help you get familiar with the task, at the beginning, one sample part of narrative will be used for practice.  After that, all the following parts will be the formal survey.\n\nNow please press \u201cspace\u201d to begin practicing.";
          psychoJS.experiment.addData('exp_question', 'tom')
      }
  }
  ...
  instructMes = [instructMes1, instructMes2, instructMes3, instructMes4, instructMes5];
  procedureImg = [procedureImg1, procedureImg2, procedureImg3, procedureImg4, procedureImg5];
  scaleImg = [scaleImg1, scaleImg2, scaleImg3, scaleImg4, scaleImg5];
  ...
  continuousSlider = new visual.Slider({
    ...
    labels: [label1, label2, label3], fontSize: 0.07, ticks: [0, 50, 100],
...
function audioPreRoutineBegin(snapshot) {
  return async function () {
    ...
    questionText.setText(continuousQ);
...
function audioPreRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('continuousSlider.response', 1);
    psychoJS.experiment.addData('continuousSlider.rt', 0);
...
function catchQuestionRoutineBegin(snapshot) {
  return async function () {
    ...
    if ((random_number_2 === 1)) {
        catchQ = (("Please click on the short vertical line on top of '" + label1) + "' to answer this question.");
        psychoJS.experiment.addData("catch_label", label1);
        psychoJS.experiment.addData("catch_value", 0);
    } else {
        if ((random_number_2 === 2)) {
            catchQ = (("Please click on the short vertical line on top of '" + label2) + "' to answer this question.");
            psychoJS.experiment.addData("catch_label", label2);
            psychoJS.experiment.addData("catch_value", 50);
        } else {
            if ((random_number_2 === 3)) {
                catchQ = (("Please click on the short vertical line on top of '" + label3) + "' to answer this question.");
                psychoJS.experiment.addData("catch_label", label3);
...
function textPreRoutineBegin(snapshot) {
  return async function () {
    ...
    questionText_2.setText(continuousQ);
